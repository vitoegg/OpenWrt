...
cp -f $GITHUB_WORKSPACE/files/Pictures/Router/bg1.jpg feeds/luci/themes/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg || log "Failed to replace Argon background"
